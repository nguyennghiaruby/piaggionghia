...
@section('list_category')
    ...
    <div class="card1">
        ...
        <div class="category_top" style="display:flex; justify-content: center; margin: 50px 0 20px 0">
            <h1 class="">Danh Sách Nhà Sản Xuất</h1>
        </div>
        ...
        <div class="card-body">
            <div class="search-bar" style="display: flex; justify-content:space-between">
                ...
                <a href="{{route('add_manufacture')}}" class="btn btn-primary">Thêm Mới</a>
            </div>
          <table id="example1" class="table" style="text-align: center">
                ...
                <tr>
                    ...
                    <td><a href="{{route('show_manufacture', ['id'=>$manufacture->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    <td><a style="color:red" onclick="return confirm('Delete selected data?')"
                        href="{{route('delete_manufacture', ['id'=>$manufacture->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
