...
<!-- Topbar End -->
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Sửa Thông Tin Người Dùng</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="{{route('client_index')}}">---Trang Chủ---</a></p>
            </div>
            <div class="d-inline-flex">
                <img src="{{asset('uploads/'.Auth::user()->avatar)}}" width="200px" height="200px" alt="error" style="border-radius: 100%">
            </div>
        </div>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <p>Tên Người Dùng</p>
                    <input type="text" class="form-control form-control-user" value="{{$user->name}}" name="name" id="exampleFirstName">
                    @if ($errors->all())
                ...
                <div class="col-sm-6">
                    <p>Địa Chỉ Email</p>
                    <input type="text" class="form-control form-control-user" name="email" value="{{Auth::user()->email}}" id="exampleLastName">
                    @if ($errors->all())
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <p>Số Điện Thoại</p>
                    <input type="text" class="form-control form-control-user" value="{{Auth::user()->phone}}" name="phone" id="exampleFirstName">
                    @if ($errors->all())
                ...
                <div class="col-sm-6">
                    <p>Ngày Sinh</p>
                    <input type="date" class="form-control form-control-user" name="birthday" value="{{Auth::user()->birthday}}" id="exampleLastName">
                    @if ($errors->all())
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <p>Địa Chỉ</p>
                    <input type="text" class="form-control form-control-user" value="{{Auth::user()->address}}" name="address" id="exampleFirstName">
                    @if ($errors->all())
                ...
                <div class="col-sm-6">
                    <p>Hình ảnh</p>
                    <input type="file" class="form-control form-control-user" name="avatar" value="{{Auth::user()->avatar}}" id="exampleLastName">
                </div>
            </div>
            @if (isset($msg))
            <p style="color: red">{{$msg}}</p>
            @endif
            <input class="btn btn-primary btn-user btn-block" type="submit" value="Sửa Thông Tin">
            <hr>
        </form>
    </div>
    <!-- Page Header End -->
