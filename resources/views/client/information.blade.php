...
<!-- Topbar End -->
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Thông Tin Người Dùng</h1>
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0" style="display: flex; justify-content: center;">
                    <p>Tên Người Dùng: {{Auth::user()->name }}</p>
                </div>
                <div class="col-sm-6 mb-3 mb-sm-0" style="display: flex; justify-content: center;">
                    <p>Địa Chỉ Email: {{Auth::user()->email }}</p>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0" style="display: flex; justify-content: center;">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0" style="display: flex; justify-content: center;">
                    <p>Địa Chỉ Người Dùng: {{Auth::user()->address }}</p>
                </div>
                <div class="col-sm-6 mb-3 mb-sm-0" style="display: flex; justify-content: center;">
